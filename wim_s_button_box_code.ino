...
byte rowPins[NUMROWS] = {10,14,15,16}; //change "?" to the pins the rows of your button matrix are connected to
byte colPins[NUMCOLS] = {5,6,7,8,9}; //change "?" to the pins the rows of your button matrix are connected to
